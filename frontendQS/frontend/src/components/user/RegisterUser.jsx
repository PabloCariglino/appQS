...
const RegisterUser = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <div className="flex-grow mt-24 px-4 sm:px-6 md:px-10 py-10">
        {successMessage && (
        ...
        <div className="flex justify-center items-center ">
          <form
            ...
            className="bg-dashboard-background p-8 rounded-lg max-w-md w-full shadow-lg"
          >
            <h2 className="text-center text-2xl md:text-3xl font-bold mb-2 text-red-600 py-4">
              Registrar Usuario
            </h2>
            <div className="mb-4">
            ...
            <button
              type="submit"
              className="w-full bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-300 mt-4"
            >
              Registrar
            </button>
          </form>
